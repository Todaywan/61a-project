...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    gains=3*abs((player_score%10)-(opponent_score//10)%10)
    if gains ==0:
        return 1
    return gains
    # END PROBLEM 2
...
def play(strategy0, strategy1, update,
    ...
    while score0<goal and score1<goal:
        if who==0:
            strategy=strategy0
            score0=update(strategy(score0,score1),score0,score1,dice)
        else:
            strategy=strategy1
            score1=update(strategy(score1,score0),score1,score0,dice)
        who=not who
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    Rolling fewer dice when not necessary.
    Roll 0 whenever it would give you more points.
    """
    # BEGIN PROBLEM 12
    ...
    return sus_strategy(score,opponent_score, threshold=7, num_rolls=6)
